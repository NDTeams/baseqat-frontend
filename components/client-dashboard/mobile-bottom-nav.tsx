...
const navItems = [
  { href: "/client-dashboard/index", label: "الرئيسية", icon: faHome },
  { href: "/client-dashboard/profile", label: "البروفايل", icon: faUser },
  { href: "/client-dashboard/attendance", label: "الحضور", icon: faCalendarCheck },
  ...
  { href: "/client-dashboard/orders", label: "الطلبات", icon: faShoppingBag },
