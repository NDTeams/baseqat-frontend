...
import CoursesFilters from '@/components/dashboard/CoursesFilters';
import CoursesTableBody from '@/components/dashboard/CoursesTableBody';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 text-start">
        <h3 className="text-4xl font-bold text-gray-800 mb-2">جدول الدورات التدريبية</h3>
      </div>
